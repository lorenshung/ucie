...
//   )
//   def MBTRAIN_START_TX_INIT_D_TO_C_POINT_TEST_REQ = BitPat(
//     "b????????????????????????????????????????????????????????????????????????????????????????00000001??????????10000101?????????00000",
//   )
//   def MBTRAIN_START_TX_INIT_D_TO_C_POINT_TEST_RESP = BitPat(
//     "b????????????????????????????????????????????????????????????????????????????????????????00000001??????????10001010?????????00000",
//   )

//   def MBTRAIN_TX_INIT_D_TO_C_RESULTS_REQ = BitPat(
//     "b????????????????????????????????????????????????????????????????????????????????????????00000011??????????10000101?????????00000",
//   )
//   def MBTRAIN_TX_INIT_D_TO_C_RESULTS_RESP = BitPat(
//     "b????????????????????????????????????????????????????????????????????????????????????????00000011??????????10001010?????????00000",
//   )

//   def MBTRAIN_END_TX_INIT_D_TO_C_POINT_TEST_REQ = BitPat(
//     "b????????????????????????????????????????????????????????????????????????????????????????00000100??????????10000101?????????00000",
//   )
//   def MBTRAIN_END_TX_INIT_D_TO_C_POINT_TEST_RESP = BitPat(
//     "b????????????????????????????????????????????????????????????????????????????????????????00000100??????????10001010?????????00000",
//   )
...
object SBMessage_factory {
  def apply(
    ...
    val new_msg = Cat(data, (msg.U(64.W) | msgInfo << (32 + 8).U)(63, 0))
